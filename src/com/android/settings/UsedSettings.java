...
public class UsedSettings extends PreferenceActivity implements
    ...
    private static class HeaderAdapter extends ArrayAdapter<Header> {
        ...
        public HeaderAdapter(Context context, List<Header> objects,
            ...
            switcherHelpers.setmWifiEnabler(mWifiEnabler);
            mBluetoothEnabler = new BluetoothEnabler(context, new Switch(
                    context));
            switcherHelpers.setmBluetoothEnabler(mBluetoothEnabler);
            mDataEnabler = new DataEnabler(context, new Switch(context));
            switcherHelpers.setmDataEnabler(mDataEnabler);
        }
            ...
            switch (headerType) {
                ...
                case HEADER_TYPE_SWITCH:
                    ...
                    if (header.id == R.id.wifi_settings) {
                        if (switcherHelpers.getIsWifi() == 0) {
                            mWifiEnabler.setSwitch(holder.switch_);
                            switcherHelpers.setIsWifi(1);
                        }
                    } else if (header.id == R.id.bluetooth_settings) {
                        if (switcherHelpers.getIsBluetooth() == 0) {
                            mBluetoothEnabler.setSwitch(holder.switch_, true);
                            switcherHelpers.setIsBluetooth(1);
                        }
                    } else if (header.id == R.id.data_usage_settings) {
                        if (switcherHelpers.getIsData() == 0) {
                            mDataEnabler.setSwitch(holder.switch_);
                            switcherHelpers.setIsData(1);
                        }
                    }
    ...
    public static class InputMethodAndLanguageSettingsActivity extends UsedSettings { /* empty */ }
    public static class KeyboardLayoutPickerActivity extends UsedSettings { /* empty */ }
    public static class InputMethodAndSubtypeEnablerActivity extends UsedSettings { /* empty */ }
    ...
    public static class AccountSyncSettingsInAddAccountActivity extends UsedSettings { /* empty */ }
    ...
    public static class WifiDisplaySettingsActivity extends UsedSettings { /* empty */ }
    ...
    public static class ProfilesSettingsActivity extends UsedSettings { /* empty */ }
    public static class QuietHoursSettingsActivity extends UsedSettings { /* empty */ }
    public static class DreamSettingsActivity extends UsedSettings { /* empty */ }
    public static class ROMSettingsActivity extends UsedSettings { /* empty */ }
}