...
public class SystemSettings extends PreferenceActivity
    ...
    public static class WifiDisplaySettingsActivity extends SystemSettings { /* empty */ }
    ...
    public static class ProfilesSettingsActivity extends SystemSettings { /* empty */ }
    public static class QuietHoursSettingsActivity extends SystemSettings { /* empty */ }
    public static class DreamSettingsActivity extends SystemSettings { /* empty */ }
    public static class ROMSettingsActivity extends SystemSettings { /* empty */ }
}